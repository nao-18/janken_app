...
class ResultActivity : AppCompatActivity() {
    ...
    private fun getHand(): Int {
        ...
        var winningStreakCount = pref.getInt("WINNING_STREAK_COUNT", 0)
        var lastMyHand = pref.getInt("LAST_MY_HAND", 0)
        var lastComHand = pref.getInt("LAST_COM_HAND", 0)
        var beforeLastComHand = pref.getInt("BEFORE_LAST_COM_HAND", 0)
        var gameResult = pref.getInt("GAME_RESULT", -1)
